...
If `~/.path` exists, it will be sourced along with the other files, before any feature testing (such as [detecting which version of `ls` is being used](https://github.com/Meesayen/dotfiles/blob/aff769fd75225d8f2e481185a71d5e05b76002dc/.aliases#L21-26)) takes place.
...
You could also use `~/.extra` to override settings, functions and aliases from my dotfiles repository. It’s probably better to [fork this repository](https://github.com/Meesayen/dotfiles/fork) instead, though.
...
[welcome](https://github.com/Meesayen/dotfiles/issues)!

## Author

| [Federico Giovagnoli](https://github.com/Meesayen) |

## Thanks to…

* [Mathias Bynens](https://mathiasbynens.be/) for his [doftiles](https://github.com/mathiasbynens/dotfiles)
